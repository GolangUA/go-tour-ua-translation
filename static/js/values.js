...
value('tableOfContents', [{
    ...
    'description': '<p>Ласкаво просимо до <a href="https://golang.org">Go спільноти</a>. Цей інтерактивний посібник охоплює розгляд найголовніших компонентів мови, включаючи:</p>',
    'lessons': ['welcome']
}, {
    'id': 'basics',
    'title': 'Основи',
    ...
    'id': 'generics',
    'title': 'Параметризовані типи',
    'description': '<p>Навчіться використовувати параметризовані тими з функціями та структурами.</p>',
    'lessons': ['generics']
}, {
    'id': 'concurrency',
